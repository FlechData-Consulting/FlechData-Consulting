...
💼 **Experience:** Data Science, Financial Analysis, and AI/Data Engineering in across both corporate and freelance projects
...
| [**Financial Fraud Detection**](https://github.com/FlechData-Consulting/FlechData-Consulting/tree/main/D%C3%A9tection_fraudes_financi%C3%A8res) | Machine learning model for detecting suspicious transactions in real time.                                                     | Python, Power BI, SQL Server, Google Cloud Platform (GCP) | Reduces financial losses through automated alerts.                                                                                                                   |
| [**Customer Journey Audit at SIRPLUS**](https://github.com/FlechData-Consulting/FlechData-Consulting/tree/main/Kundenreise)                      | Developed automated dashboards for cost tracking, margin analysis, and financial forecasting.                                  | Python, Power BI, SQL Server, Google Cloud Platform (GCP) | • Optimized the customer experience<br>• Analyzed customer behavior across devices, segments, and traffic sources<br>• Evaluated and enhanced the marketing strategy |
| [**2021 Olympics in Tokyo**](https://github.com/FlechData-Consulting/FlechData-Consulting/tree/main/ProjectIU)                                  | Analysis and visualization of Olympic data to extract insights on athlete performance, country rankings, and event statistics. | Python, Pandas, Matplotlib, Seaborn, SQL                  | Enables data-driven insights into athlete and country performance; supports reporting and analytics.                                                                 |
